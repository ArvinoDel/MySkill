    ...
    <section class="home w-screen">
        ...
        <div class="lg:grid flex flex-col-reverse lg:grid-cols-2">
            <div class="text-start px-10 lg:px-20 py-2 lg:py-4">
                ...
                <h1 class="text-black text-lg pt-7 font-semibold">Intensive Live Class bersama Experts. Praktikal &
                    Mendalam
                </h1>
                <div class="ms-3">
                    <li class="font-semibold">
        ...
        <div class="snap-x snap-mandatory flex overflow-x-auto ps-6 gap-5 lg:gap-11"
            ...
            <div class="snap-always snap-center flex-shrink-0 w-48 h-24 border border-black rounded-xl">
                <img class="flex justify-center mx-16 mt-4 w-16" src="{{ asset('assets/home/aws.svg') }}"
                    alt="" />
            </div>
        ...
        <div class="snap-x snap-mandatory flex overflow-x-auto ps-6 gap-5 lg:gap-11"
            ...
            <div class="snap-always snap-center flex-shrink-0 w-48 h-24 border border-black rounded-xl">
                <img class="flex justify-center mx-6 mt-9 w-36" src="{{ asset('assets/home/idn.svg') }}"
                    alt="" />
            </div>

            <div class="snap-always snap-center flex-shrink-0 w-48 h-24 border border-black rounded-xl">
                <img class="flex justify-center mt-6 mx-4 w-40" src="{{ asset('assets/home/cnbc.svg') }}"
                    alt="" />
            </div>
            ...
            <div class="relative inline-block w-full lg:px-32 py-4">
                <div>
                    <button type="button" onclick="toggleDropdown('dropdown1')"
                        class="inline-flex text-start justify-between w-full px-4 text-lg font-medium text-dark"
                        id="menu-button1" aria-expanded="false" aria-haspopup="true">
