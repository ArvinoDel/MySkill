...
@section('container')
    <div class="w-full h-full  rounded-b-3xl bg-white lg:bg-gradient-to-b from-orange-400 to-red-500">
    ...
    <div class="snap-x snap-mandatory flex overflow-x-auto ps-6 gap-11"
        ...
        <div
            class="snap-always snap-center flex-shrink-0 w-48 h-20 border border-black rounded-xl">
