...
<div class="w-screen h-auto  rounded-b-3xl bg-white lg:bg-gradient-to-b from-orange-400 to-red-500">
    <div class="snap-x snap-mandatory flex overflow-x-auto gap-6 mx-4" style="scrollbar-width: none; -ms-overflow-style: none;" ontouchstart="this.classList.add('touching')" ontouchend="this.classList.remove('touching')" onmousedown="this.classList.add('touching')" onmouseup="this.classList.remove('touching')">
...
<div class="snap-x snap-mandatory flex overflow-x-auto ps-6 gap-11" style="scrollbar-width: none; -ms-overflow-style: none;" ontouchstart="this.classList.add('touching')" ontouchend="this.classList.remove('touching')" onmousedown="this.classList.add('touching')" onmouseup="this.classList.remove('touching')">

    <div class="snap-always snap-center flex-shrink-0 w-52 h-44 bg-gradient-to-b from-orange-400 to-red-500 border rounded-lg">
...
<div class="snap-x snap-mandatory flex overflow-x-auto ps-6 gap-11" style="scrollbar-width: none; -ms-overflow-style: none;" ontouchstart="this.classList.add('touching')" ontouchend="this.classList.remove('touching')" onmousedown="this.classList.add('touching')" onmouseup="this.classList.remove('touching')">
    <div class="snap-always snap-center flex-shrink-0 w-52 h-96 bg-gradient-to-b from-orange-400 to-red-500 border rounded-xl">
...
<div class="snap-x snap-mandatory flex overflow-x-auto ps-6 gap-11" style="scrollbar-width: none; -ms-overflow-style: none;" ontouchstart="this.classList.add('touching')" ontouchend="this.classList.remove('touching')" onmousedown="this.classList.add('touching')" onmouseup="this.classList.remove('touching')">
    ...
    <div class="snap-always snap-center flex-shrink-0 w-48 h-20 border border-black rounded-xl">
        <img class="flex justify-center mt-2 mx-14 w-20" src="{{ asset('assets/home/linkedin.svg') }}" alt="" />
    </div>

    <div class="snap-always snap-center flex-shrink-0 w-48 h-20 border border-black rounded-xl">
        <img class="flex justify-center mx-16 mt-2 w-16" src="{{ asset('assets/home/kominfo.svg') }}" alt="" />
    </div>

    <div class="snap-always snap-center flex-shrink-0 w-48 h-20 border border-black rounded-xl">
        <img class="flex justify-center mx-4 my-1 w-40" src="{{ asset('assets/home/startup.svg') }}" alt="" />
    </div>
...
<div class="snap-x snap-mandatory flex overflow-x-auto ps-6 gap-11" style="scrollbar-width: none; -ms-overflow-style: none;" ontouchstart="this.classList.add('touching')" ontouchend="this.classList.remove('touching')" onmousedown="this.classList.add('touching')" onmouseup="this.classList.remove('touching')">
    ...
    <div class="snap-always snap-center flex-shrink-0 w-48 h-20 border border-black rounded-xl">
        <img class="flex justify-center mx-12 mt-1 w-20" src="{{ asset('assets/home/techinasia.svg') }}" alt="" />
    </div>
    ...
    <div class="snap-always snap-center flex-shrink-0 w-48 h-20 border border-black rounded-xl">
        <img class="flex justify-center mx-4 mt-8 w-40" src="{{ asset('assets/home/technode.svg') }}" alt="" />
    </div>
