    ...
    <section class="w-full h-auto rounded-b-3xl bg-white lg:bg-gradient-to-b from-orange-400 to-red-400 text-white flex">
        ...
        <div class="ml-4 mt-8">
            ...
            <div class="flex justify-center mb-4 space-x-4">
                <div class="bg-white text-black p-6 rounded-lg w-64">
    ...
    <section class="w-screen h-auto">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg flex items-center justify-between">
            <div class="ml-80">
                ...
                <button type="button" class="focus:outline-none text-white bg-pink-600 font-medium rounded-full text-sm px-5 py-2.5 me-2 dark:focus:ring-yellow-900">Pelajari Performance Management Software</button>
            </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg flex items-center">
            ...
            <div>
                ...
                <button type="button" class="focus:outline-none text-white bg-pink-600 font-medium rounded-full text-sm px-5 py-2.5 me-2 dark:focus:ring-yellow-900">Hubungi Tim MySkill</button>
            </div>
        </div>

        <div class="min-h-screen flex items-center justify-center bg-white">
            <div class="mx-auto p-6 bg-white shadow-lg w-full">
