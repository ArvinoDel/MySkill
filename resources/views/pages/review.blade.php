                ...
                <div class="w-screen lg:w-3/4 px-4">
                    <div class="bg-white rounded-lg p-6 mb-8">
                        <p id="tentang-bootcamp"
                            class="text-orange-600 lg:ml-4 lg:text-xl max-sm:text-lg max-sm:ml-2 font-bold">
                    ...
                    <div class="bg-white rounded-lg p-6">
                        <p id="untuk-siapa-saja"
                            class="text-orange-600 lg:ml-4 lg:text-xl max-sm:text-lg max-sm:ml-2 max-sm:mb-4 font-bold">
                    ...
                    <div class="overflow-x-auto mt-10 no-scrollbar">
                        <div class="flex justify-between"> <!-- Added flex container for alignment -->
                            <!-- Card 1 -->
                            <div class="bg-white rounded-lg shadow-lg p-6 m-4 max-w-xs flex-shrink-0 flex flex-col">
                                <!-- Added flex column -->
