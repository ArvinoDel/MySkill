            ...
            <div class="w-full max-sm:hidden md:w-1/4 px-4 mb-8 sticky top-11 h-screen">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#benefit-tambahan" class="text-blue-600 hover:text-blue-800">Benefit Tambahan</a></li>
                        <li><a href="#untuk-siapa-saja" class="text-blue-600 hover:text-blue-800">Untuk Siapa Saja</a></li>
                        <li><a href="#harga-program" class="text-blue-600 hover:text-blue-800">Harga Program</a></li>
                    </ul>
                    <button class="w-full bg-yellow-500 text-white font-bold py-2 px-4 rounded mt-6 hover:bg-yellow-600">Daftar Sekarang</button>
                </div>
            </div>
                        ...
                        <div>
                            <ul class="space-y-2">
                                <li class="flex items-start">
                                    ...
                                    CV kamu akan direview langsung oleh HRD profesional. Baik CV magang, kerja, beasiswa dan keperluan profesional lainnya.
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    Review diberikan maksimal dalam waktu 7 hari kerja (Dilakukan pada hari dan jam kerja: Senin - Jumat, pukul 09.00 - 17.00 WIB)
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-6 h-6 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    Pembahasan detail dan mendalam untuk setiap bagian CV. Kamu akan mendapat saran editing dan contoh di tiap poin CV kamu.
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="flex space-x-6">
                            <div class="border rounded-lg p-4 flex-shrink-0 w-80">
                                <div class="flex items-center">
                                    <!-- Gambar di sebelah kiri -->
                                    <img src="./assets/corporate/benefit-additional-1.webp" alt="" class="w-24 h-24 object-cover mr-4">
                                    <!-- Tulisan di sebelah kanan -->
                                    <div>
                            ...
                            <div class="border rounded-lg p-4 flex-shrink-0 w-80">
                                <div class="flex items-center">
                                    <img src="./assets/corporate/benefit-additional-2.webp" alt="" class="w-24 h-24 object-cover mr-4">
                                    <div>
                            ...
                            <div class="border rounded-lg p-4 flex-shrink-0 w-80">
                                <div class="flex items-center">
                                    <img src="./assets/corporate/benefit-additional-3.webp" alt="" class="w-24 h-24 object-cover mr-4">
                                    <div>
                            ...
                            <div class="border rounded-lg p-4 flex-shrink-0 w-80">
                                <div class="flex items-center">
                                    <img src="./assets/corporate/benefit-additional-4.webp" alt="" class="w-24 h-24 object-cover mr-4">
                                    <div>
                            ...
                            <div class="border rounded-lg p-4 flex-shrink-0 w-80">
                                <div class="flex items-center">
                                    <img src="./assets/corporate/benefit-additional-5.webp" alt="" class="w-24 h-24 object-cover mr-4">
                                    <div>
                            ...
                            <div class="border rounded-lg p-4 flex-shrink-0 w-80">
                                <div class="flex items-center">
                                    <img src="./assets/corporate/benefit-additional-6.webp" alt="" class="w-24 h-24 object-cover mr-4">
                                    <div>
