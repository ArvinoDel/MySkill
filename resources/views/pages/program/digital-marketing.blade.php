...
@section('container')
    ...
    <div class="flex ">
        ...
        <div class="flex-1 lg:p-8 max-sm:p-2">
            ...
            <p class="text-orange-600 text-xl font-bold"><i class="fas fa-chevron-right text-orange-600 mr-3"></i>Apa Yang
                Bisa Kamu Dapatkan</p>
            <p class="lg:w-10/12">Upgrade skill mulai dari memahami konsep, analisa studi kasus, hingga praktik untuk
                mengoptimalkannya. Kuasai berbagai skill dan tools di bidang Digital Marketing untuk karier maupun bisnis
                kamu.
                <b>Contoh Skill & Portfolio yang bisa kamu miliki:</b>
            </p>
            123
            <img src="{{ asset('./assets/bootcamp/get.png') }}"
                class="lg:h-80 rounded-3xl w-auto lg:mt-4 lg:ml-2 py-2 max-sm:h-28 max-sm:w-12 max-sm:mx-auto max-sm:my-4 object-cover">
            <!-- scrollbar-2 -->
            ...
            <!-- benefit start -->
            <p class="text-orange-600 text-xl lg:mt-6 font-bold"><i
                    class="fas fa-chevron-right text-orange-600 mr-3"></i>Benefit Bootcamp</p>
            ...
            <p class="font-normal">✅ 20 Live Class Bersama Mentor Experts dari Top Companies.
                ...
                <br>
                ✅ Terdapat sesi persiapan karir untuk persiapan berkas lamaran kerja (CV, Surat Lamaran Kerja, Interview,
                Linkedin).
            </p>
            ...
            <img src="{{ asset('./assets/bootcamp/sertifikat.png') }}"
                class="lg:h-72 rounded-3xl w-auto lg:mt-4 lg:ml-8 py-2 max-sm:h-28 max-sm:w-12 max-sm:mx-auto max-sm:my-4 object-cover">
            <!-- benefit end -->

            <!-- peserta bootcamp -->
            <p class="text-orange-600 text-xl lg:mt-6 font-bold"><i
                    class="fas fa-chevron-right text-orange-600 mr-3"></i>Peserta Bootcamp</p>
            <img src="{{ asset('./assets/bootcamp/peserta.png') }}"
                class="lg:h-80 sm:h-auto rounded-3xl w-auto lg:mt-4 lg:ml-8 py-2 max-sm:h-28 max-sm:w-12 max-sm:mx-auto max-sm:my-4 object-cover">

            <!-- Kurikulum & Silabus -->
            <p class="text-orange-600 text-xl lg:mt-6 font-bold"><i
                    class="fas fa-chevron-right text-orange-600 mr-3"></i>Kurikulum & Silabus</p>
            ...
            <!-- sistem belajar -->
            <p class="text-orange-600 text-xl lg:mt-6 font-bold lg:mb-4"><i
                    class="fas fa-chevron-right text-orange-600 mr-3"></i>Sistem Belajar</p>
            <img class="MuiBox-root mui-style-nj2azm"
            ...
            <p class="text-orange-600 text-xl lg:mt-6 font-bold lg:mb-1"><i
                    class="fas fa-chevron-right text-orange-600 mr-3"></i>FAQ</p>
            ...
            <div class="border border-gray-300 rounded mt-2">
                <button class="w-full text-left bg-white p-2 rounded flex justify-between items-center"
                    ...
                    <p class="font-semibold"> Bagaimana jika saya mengalami kesulitan untuk mengerjakan team project untuk
                        portofolio saya ? </p>
                    <i class="fas fa-chevron-down" id="arrow2"></i>
                </button>
                <div id="faq3"
            ...
            <!-- Komunitas -->
            <p class="text-orange-600 text-xl lg:mt-6 font-bold lg:mb-1"><i
                    class="fas fa-chevron-right text-orange-600 mr-3"></i>Komunitas</p>
            <p class="mb-2">Bukan sekadar join Bootcamp. Tapi, Komunitas berkembang bersama. Gabung grup untuk
                berdiskusi, berbagi info loker dan freelance, hingga kumpul offline dan networking. Bangun support system
                bersama yuk!</p>
            <!-- scrollbar-3 -->
            <div name="scrollbar-2 mb-8">
                <div class="flex overflow-x-auto space-x-4 max-sm:ps-2 no-scrollbar">
                    <img src="{{ asset('./assets/bootcamp/komun1.png') }}"
                        class="lg:h-64 max-sm:h-60 lg:w-auto max-sm:w-[272px]">
    ...
    <div name="mb-8" class="overflow-x-auto no-scrollbar">
        <div class="flex space-x-4 w-max lg:px-14 max-sm:px-4 py-3">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 lg:w-64 max-sm:w-40 max-sm:h-40">
                ...
                <p class="mt-4 text-gray-700 font-semibold font-sans h-50 lg:text-lg max-sm:text-sm max-sm:truncate">
